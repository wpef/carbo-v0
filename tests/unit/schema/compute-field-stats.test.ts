// 010-field-stats — Unit tests for computeFieldStats (pure client-side, no mocks needed)
// Principle IV: realistic CRM field shapes throughout.
...
describe('computeFieldStats', () => {
  ...
  it('returns up to 5 unique sample values for Industry', () => {
    ...
    // Technology, Finance are non-null; Industry=null is excluded from samples
  ...
  it('null field value does not appear in sampleValues', () => {
    ...
    // Email is null for CON-0004 — should not be in sample values
  ...
  it('does not duplicate values in sampleValues even if they repeat in records', () => {
    ...
    // 'Prospecting' should appear only once in sampleValues
