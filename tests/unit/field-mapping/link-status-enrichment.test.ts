// Unit tests: linkStatus enrichment logic used by field-mapping-service.ts (port v4 → v5).
...
//
// v5 : buildLogicSnapshot est interne (non exporté) dans field-mapping-service.ts ;
// on simule sa construction via le helper local buildSnapshot (même contrat).
//
// Test v4 « Cluster 16 — duplicate field mapping signal » SAUTÉ : la classe
// DuplicateFieldMappingError n'existe pas en v5 — le 409 doublon est géré par
// le try/catch de la route POST /api/plans/[planId]/field-mappings.
