...
| 6 | Documents | Le document généré utilise les apiNames bruts (pas les libellés) et n'alerte pas sur les paires à 0 champ | Avec le port du moteur de documents (018/019/020) |
