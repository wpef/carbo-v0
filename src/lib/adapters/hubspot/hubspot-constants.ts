// HubSpot adapter — standard objects, creatable types, env var keys (v4 port)
 ...
 * HubSpot scopes. Custom-object operations go through `crm.objects.custom.*`
 * (Enterprise portal only); custom-object schema changes go through the standard
