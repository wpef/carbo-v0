// HubSpot — schema retrieval (standard + custom objects + properties) (v4 port)
// Ref: specs/adapters/hubspot/

import { HS_API_BASE, STANDARD_OBJECTS } from './hubspot-constants'
...
/** Map HubSpot property type -> Carbo-v0 vocabulary. */
