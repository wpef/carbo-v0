...
const DEMO_FIELDS: Record<string, ConnectorField[]> = {
  Contact: [
    ...
    { apiName: 'leadSource', label: 'Lead Source', dataType: 'picklist', isRequired: false, isReadOnly: false, isUnique: false, picklistValues: ['Web', 'Referral', 'Trade Show', 'Partner', 'Other'] },
  ...
  Account: [
    ...
    { apiName: 'industry', label: 'Industry', dataType: 'picklist', isRequired: false, isReadOnly: false, isUnique: false, picklistValues: ['Technology', 'Manufacturing', 'Healthcare', 'Finance', 'Retail', 'Other'] },
    ...
    { apiName: 'rating', label: 'Rating', dataType: 'picklist', isRequired: false, isReadOnly: false, isUnique: false, picklistValues: ['Hot', 'Warm', 'Cold'] },
  ],
  Deal: [
    { apiName: 'id', label: 'ID', dataType: 'string', isRequired: true, isReadOnly: true, isUnique: true },
    ...
    { apiName: 'stage', label: 'Stage', dataType: 'picklist', isRequired: true, isReadOnly: false, isUnique: false, picklistValues: ['Prospecting', 'Qualification', 'Proposal', 'Negotiation', 'Closed Won', 'Closed Lost'] },
