...
const DEMO_FIELDS: Record<string, ConnectorField[]> = {
  contacts: [
    ...
    { apiName: 'lifecyclestage', label: 'Lifecycle Stage', dataType: 'enumeration', isRequired: false, isReadOnly: false, isUnique: false, picklistValues: ['subscriber', 'lead', 'marketingqualifiedlead', 'salesqualifiedlead', 'opportunity', 'customer', 'evangelist'] },
    { apiName: 'hs_lead_status', label: 'Lead Status', dataType: 'enumeration', isRequired: false, isReadOnly: false, isUnique: false, picklistValues: ['New', 'Open', 'In Progress', 'Open Deal', 'Unqualified', 'Attempted to Contact', 'Connected', 'Bad Timing'] },
  ...
  companies: [
    ...
    { apiName: 'phone', label: 'Phone Number', dataType: 'phone', isRequired: false, isReadOnly: false, isUnique: false },
    { apiName: 'industry', label: 'Industry', dataType: 'enumeration', isRequired: false, isReadOnly: false, isUnique: false, picklistValues: ['Technology', 'Manufacturing', 'Healthcare', 'Finance', 'Retail', 'Education', 'Other'] },
  ...
  deals: [
    ...
    { apiName: 'dealstage', label: 'Deal Stage', dataType: 'enumeration', isRequired: true, isReadOnly: false, isUnique: false, picklistValues: ['appointmentscheduled', 'qualifiedtobuy', 'presentationscheduled', 'decisionmakerboughtin', 'contractsent', 'closedwon', 'closedlost'] },
    { apiName: 'pipeline', label: 'Pipeline', dataType: 'enumeration', isRequired: true, isReadOnly: false, isUnique: false, picklistValues: ['default', 'enterprise', 'partner'] },
