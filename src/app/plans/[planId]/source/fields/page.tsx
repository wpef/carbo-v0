// 005-source-field-retrieval — Source fields page (Cluster 15)
    ...
    <main className="max-w-4xl mx-auto p-8">
      ...
      {hasFields && !loading && (
        <div className="mb-4 flex items-center gap-4 text-sm text-muted-foreground">
          <span><strong className="text-foreground">{totalObjects}</strong> object{totalObjects !== 1 ? 's' : ''}</span>
          <span><strong className="text-foreground">{totalFields}</strong> total fields</span>
