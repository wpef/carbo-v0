// 020-contractual-document — FR-013 : Générateur de numéro de référence contractuel
//
...
//
// En production, la garantie d'unicité inter-session est assurée par une
// transaction DB dans la couche service (câblée ultérieurement).
 ...
 * Exemple : CARBO-20260616-0001, CARBO-20260616-0002, …
 */
...
/**
 * Variante déterministe pour les tests : génère un numéro à partir d'une
 * date et d'un numéro de séquence fournis explicitement.
 *
 * N'affecte pas le compteur interne.
 */
 ...
 * Permet d'avoir des numéros prévisibles dans un test suite.
 */
