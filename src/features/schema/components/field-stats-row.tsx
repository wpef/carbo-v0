...
// Stats computed client-side via computeFieldStats (FR-002: fill rate, distinct, samples).

'use client'

import type { FieldStats } from '@/lib/types/connector'
...
function truncate(value: unknown): string {
  ...
  if (str.length > MAX_SAMPLE_DISPLAY_LENGTH) return str.slice(0, MAX_SAMPLE_DISPLAY_LENGTH) + '…'
  return str
}
