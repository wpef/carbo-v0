// 005-source-field-retrieval — Single field row in the field table
...
const DATA_TYPE_COLORS: Record<string, string> = {
  ...
  id: 'bg-blue-50 text-blue-700 border-blue-200',
  ...
  enumeration: 'bg-orange-50 text-orange-700 border-orange-200',
